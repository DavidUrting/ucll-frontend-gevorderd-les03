...
function checkUrl() {
    ...
    try {
        ...
        if (url.protocol.toLowerCase().startsWith("http")) {           
            document.getElementById("feedback").className = "badge badge-success"; // Dit zijn een Boostrap 4 classes. Meer info over 'badge': https://getbootstrap.com/docs/4.0/components/badge/
            ...
            document.getElementById("feedback").className = "badge badge-warning"; // Dit zijn een Boostrap 4 classes.
            document.getElementById("feedback").innerText = "Geldig (!)";
        ...
        document.getElementById("feedback").className = "badge badge-danger"; // Dit zijn een Boostrap 4 classes.
